...
<div class="container-fluid py-5 px-4">
    ...
    <div id="mobile" style="display: none">
        <div class="justify-content-center">
            ...
            <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasHelp" aria-labelledby="offcanvasHelpLabel">
                ...
                <div class="offcanvas-body" style="color: white; text-align: justify">
                    ...
                    <p><strong>Menu Informasi Kegiatan Desa</strong> berisi berbagai informasi mengenai seluruh kegiatan yang berada di {{ $profil->namaDesa }}, baik yang dilakukan oleh pemerintahan maupun masyarakat Desa Tappung Jaya. Tekan salah satu kegiatan desa untuk melihat informasi lebih detail.</p>
                </div>
            </div>
        
            <div class="px-3" style="text-align: center">
                <h6 class="text-center" style="font-family: 'Raleway', sans-serif;">Berikut Merupakan Informasi Mengenai Kegiatan {{ $profil->namaDesa }}</h6>
        ...
        <form action="/informasiPublic/kegiatan">
    ...
    <div class="d-flex justify-content-center mb-3" >
        {{ $kegiatan->links('layout.pagination') }}
    </div>
        @else
            <div style="text-align: center">
                <img src="../images/kegiatanNT.png" width="300px">
            </div>
        @endif
    </div>
    ...
    <div id="normal">
        <div class="justify-content-center">
            ...
            <div class="px-3" style="text-align: center">
                <h3 class="text-center" style="font-family: 'Raleway', sans-serif;">Berikut Merupakan Informasi Mengenai Kegiatan {{ $profil->namaDesa }}</h3>
        ...
        <div class="card mb-3 text-center">
            <div style="height: 500px; width: auto; overflow: hidden;">
                <img src="{{ asset('storage/' . $kegiatan[0]->fotoUtamaKegiatan) }}" class="card-img-top" alt="..." style=" border-radius: 20px; overflow: hidden;">
            </div>
            <div class="card-body">
                <h4 class="card-title" style="font-family: 'Raleway', sans-serif; text-transform: capitalize; font-weight: bold;">{{ $kegiatan[0]->title }}</h4>
                <p class="card-text"><small class="text-muted">Last Update {{ $kegiatan[0]->created_at->diffForHumans() }}</small></p>
                {{-- <p class="card-text"><small class="text-muted">Last Update {{( $kegiatan[0]->created_at)->format('d F Y') }}</small></p> --}}
                <p class="card-text" style="height: 80px; overflow: hidden; text-align: justify">{{ $kegiatan[0]->excerptKegiatan }}</p>
            </div>
    
            <div class="card-body">
                <a href="/informasiPublic/kegiatan/{{ $kegiatan[0]->slug }}" class="card-link btn btn-success">Read More</a>
            </div>
        </div>
    
        <div class="row py-4">
            
            @foreach ($kegiatan->skip(1) as $item)
                <div class="col-md-3 mb-5">
                    <div class="card" style="width: 19rem; ">
                        ...
                        <div class="card-body">
                            <h6 class="card-title" style="height: 80px; text-align: center; text-transform: capitalize; font-weight: bold; text-align: justify">{{ $item->title }}</h6>
                            <p class="card-text"><small class="text-muted">Last Update {{ $item->created_at->diffForHumans() }}</small></p>
                            <p class="card-text" style="height: 150px; overflow: hidden; text-align: justify">{{ $item->excerptKegiatan }} </p>
                        </div>
        ...
        @else
            <div style="text-align: center">
                <img src="../images/kegiatanNT.png" width="500px">
            </div>
        @endif

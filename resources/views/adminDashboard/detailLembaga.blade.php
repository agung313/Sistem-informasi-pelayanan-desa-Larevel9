    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="card" style="width: 100%; height: 100%; background-color: white; padding: 20px">
                        ...
                        <table class="table" style="text-align: left; color: black">
                            ...
                            @foreach ($jabatan as $item) 
                                <tr style="width: 100%">
                                    ...
                                    <td style="vertical-align: middle;  width: 45%">{{ $item->posisiJabatan }}</td>
                                    ...
                                    <form action="/anggotas" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <label for="fotoAnggota" class="form-label" style="font-weight: bold">Foto Anggota</label>
                        ...
                        <table class="table" style="text-align: left; color: black">
                            ...
                            @foreach ($anggota as $agt) 
                                <tr style="width: 100%">
                                    ...
                                    @if ($agt->fotoAnggota)
                                        <td style="vertical-align: middle;"><img src="{{ asset('storage/' . $agt->fotoAnggota) }}" alt="" width="80px" height="100px"></td> 
                                    @else
                                        <td style="vertical-align: middle;"><img src="/images/pas.png" alt="" height="90px" width="80px" style="overflow: hidden"></td> 
                                    @endif
                                    <td style="vertical-align: middle; width: 40%">{{ $agt->namaAnggota }}</td>
                                    {{-- <td style="vertical-align: middle; width: 30%; ">{{ $agt->lembaga->singkatanLembaga}}</td> --}}
                                    <td style="vertical-align: middle; text-transform: uppercase; width: 30% ">{{ $agt->jabatan->posisiJabatan }}</td>
                                    <td style="text-align: center;  ">
            ...
            <div id="kegiatanLembaga" class="mb-5">
                ...
                <div class="py-3">
                    <a class="btn btn-primary" href="/lembaga/kegiatan/{{ $user->lembaga_id }}">Tambah Data Kegiatan </a>
                </div>
                <div class="row py-4" style="margin-left: 40px">
                    ...
                    <table class="table" style="text-align: left; color: black">
                        ...
                        @foreach ($kegiatan as $item) 
                            <tr style="width: 100%">
                                <td style="vertical-align: middle; width: 5%; ">{{ $loop->iteration }}</td>
                                <td style="vertical-align: middle; width: 45%">{{ $item->title }}</td>
                                {{-- <td style="vertical-align: middle; width: 30%; ">{{ $item->lembaga->singkatanLembaga}}</td> --}}

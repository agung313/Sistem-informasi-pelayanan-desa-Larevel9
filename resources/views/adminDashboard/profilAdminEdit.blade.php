        ...
        <div class="card" style="width: 100%; height: 100%; background-color: white; padding: 20px">
            <form action="/profilDesa/{{ $profil->id }}" method="post" enctype="multipart/form-data">
                ...
                <div style="text-align: center; justify-content: center">
                    <img src="{{ asset('storage/' . $profil->logoDesa) }}" class="img-fluid rounded-start"
                        style="width: 150px">
                ...
                <div class="py-4">
                    <div class="mb-3">
                        ...
                        @if ($profil->logoDesa)
                            <img src="{{ asset('storage/' . $profil->logoDesa) }}" class="img-preview mb-3  d-block"
                                style="height: 80px">
                        @else
                            <img class="img-preview mb-3 " style="height: 80px">
                        @endif

                        <input class="form-control @error('logoDesa') is-invalid @enderror" type="file" id="logoDesa"
                            name="logoDesa" onchange="previewImage()">
                        @error('logoDesa')
                            <div class="invalid-feedback">
                                <p style="text-align: left">{{ $message }}</p>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('namaDesa') is-invalid @enderror" id="namaDesa"
                            name="namaDesa" placeholder="Input Nama Desa " autofocus required
                            value="{{ old('namaDesa', $profil->namaDesa) }}">
                        @error('namaDesa')
                            <div class="invalid-feedback">
                                <p style="text-align: left">{{ $message }}</p>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kepalaDesa') is-invalid @enderror" id="kepalaDesa"
                            name="kepalaDesa" placeholder="Input Nama Kepala Desa " autofocus required
                            value="{{ old('kepalaDesa', $profil->kepalaDesa) }}">
                        @error('kepalaDesa')
                            <div class="invalid-feedback">
                                <p style="text-align: left">{{ $message }}</p>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kecamatan') is-invalid @enderror" id="kecamatan"
                            name="kecamatan" placeholder="Input Kecamatan" autofocus required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kabupaten') is-invalid @enderror" id="kabupaten"
                            name="kabupaten" placeholder="Input Kabupaten" autofocus required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('provinsi') is-invalid @enderror" id="provinsi"
                            name="provinsi" placeholder="Input Provinsi" autofocus required
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('luasDesa') is-invalid @enderror" id="luasDesa"
                            name="luasDesa" placeholder="Input Luas Desa" autofocus required
                            value="{{ old('luasDesa', $profil->luasDesa) }}">
                        @error('luasDesa')
                            <div class="invalid-feedback">
                                <p style="text-align: left">{{ $message }}</p>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('jumlahDusun') is-invalid @enderror"
                            id="jumlahDusun" name="jumlahDusun" placeholder="Input Jumlah Dusun" autofocus
                            required value="{{ old('jumlahDusun', $profil->jumlahDusun) }} ">
                        @error('jumlahDusun')
                            <div class="invalid-feedback">
                                <p style="text-align: left">{{ $message }}</p>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('jumlahKeluarga') is-invalid @enderror"
                            id="jumlahKeluarga" name="jumlahKeluarga" placeholder="Input Jumlah Keluarga"
                            autofocus required value="{{ old('jumlahKeluarga', $profil->jumlahKeluarga) }} ">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('jumlahJiwa') is-invalid @enderror"
                            id="jumlahJiwa" name="jumlahJiwa" placeholder="Input Jumlah Jiwa" autofocus
                            required value="{{ old('jumlahJiwa', $profil->jumlahJiwa) }} ">
                        @error('jumlahJiwa')
                            <div class="invalid-feedback">
                                <p style="text-align: left">{{ $message }}</p>
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="sejarah" type="hidden" name="sejarah"
                            value="{{ old('sejarah', $profil->sejarah) }}">
